...
const CertificatesSection = () => {
  const items = [
    ...
    },
    {
      id: 4,
      title: "Jurnal 3",
      imageUrl: Journal3Img,
    },
    {
      id: 4,
      title: "Jurnal 4",
      imageUrl: Journal4Img,
    },
    {
      id: 4,
      title: "Jurnal 5",
      imageUrl: Journal5Img,
    },
    {
      id: 4,
      title: "Jurnal 6",
      imageUrl: Journal6Img,
    },
    {
      id: 4,
      title: "Jurnal 7",
      imageUrl: Journal7Img,
    },
  ];

  return (
    <section id="certificates" className="certificatesSection">
