...
const MenuSection = () => {
 ...
 list.scrollTo({
  ...
  const containerVariants = {
    hidden: { opacity: 0 },
    visible: { opacity: 1, transition: { staggerChildren: 0.1 } } // Eksik virgül
  // Eksik noktalı virgül veya başka bir hata
  const itemVariants = {
            ...
            <>
              ...
              <div className="product-info-section">
                <div className="product-info-preview">
                  ...
                  <p>
                    Kətan yağı sağlamlıq üçün ən vacib sayılan yağlardandır. Tərkibindəki omega yağları və vitaminlər sayəsində orqanizmdə maddələr mübadiləsini yaxşılaşdırır, qanda xolesterinin miqdarını azaldır.
                  </p>
                  <motion.button
                    className="read-more-button"
                ...
                <AnimatePresence>
                  {expandedSection === "ketan" && (
                    ...
                    >
                      <p>
                        Bioloji fəallığa malik qida əlavəsinin istifadəsinə dair təlimat. Yağın rəngi və ətri: açıq sarı rəngli, xoş ətirli.
                      </p>
                      <p>
                        <strong>Tərkibi:</strong> Doymamış və polidoymamış yağ turşuları: omega 3 (linolen) 55%, omega 6 (linol) 16%, olein 21%, palmitin 5%, araxin 0,5%, miristin 0,1% və sair, A, B, E, F, K vitaminləri, Fe, Zn, Mg, Ca və P mineralları, amin turşuları.
                      </p>
                      <p>
                        <strong>Farmakoloji xüsusiyyətləri:</strong> Kətan yağı sağlamlıq üçün ən vacib sayılan yağlardandır. Kətan yağından istifadə etmək orqanların işini normallaşdırır. Yağın tərkibində olan A, B, E, F, K vitaminləri, doymamış və polidoymamış yağ turşuları ilə, həmçinin fitosterol, xolin, fosfor, kalsium, sink və kaliumla zəngindir. Tərkibində olan omega যাğı sayəsində kətan yağı orqanizmdə maddələr mübadiləsini yaxşılaşdırır, qanda xolesterinin miqdarının azalmasına səbəb olur, damar divarlarının elastikliyini artırır. Kətan yağı həzm sisteminin və qaraciyər funksiyasının yaxşılaşmasına, qəbizliyin, qıcqırmanın aradan qalxmasına səbəb olur, parazit əleyhinə təsir göstərir.
                      </p>
                      <p>
                        <strong>Kosmetik effekt:</strong> Dərinin vitamin və minerallara olan ehtiyacını ödəyir, dərini cavanlaşdırır, ona bakterisid təsir göstərir.
                      </p>
                      <ul>
                        <li><strong>Omega 3:</strong> Orqanizm bu yağı istehsal etmədiyi üçün qidalanma yolu ilə qəbul edilməsi lazımdır. Omega 3 yağ turşuları yaxşı xolesterolu artırır. Triqliseridlər qan təzyiqini və arterial lövhələrin əmələ gəlməsini azaldır.</li>
                        <li><strong>Omega 6:</strong> Qlükozanın udulmasını artırır, immunitet sisteminin gücləndirilməsində iştirak edir. Qanda xolesterinin səviyyəsini aşağı salır və qan damarlarının divarlarında xolesterin lövhələrinin çökməsinin qarşısını alır, toxuma mübadiləsini yaxşılaşdıraraq orqanizmdə xroniki iltihabın inkişafını azaldır.</li>
                        <li><strong>A vitamini:</strong> Görmə qabiliyyətini qorumağa kömək edir, bədənin qoruyucu funksiyasını artırır, maddələr mübadiləsini yaxşılaşdırır.</li>
                        <li><strong>B qrupu vitaminləri:</strong> Mərkəzi sinir sisteminin işinə müsbət təsir göstərir.</li>
                        <li><strong>E vitamini:</strong> Sinir sisteminin, əzələlərin, hipofiz və adrenal vəzlər kimi endokrin vəzlərin və reproduktiv orqanların funksiyası üçün vacibdir.</li>
                        <li><strong>K vitamini:</strong> Immuniteti gücləndirir, sinir sisteminin sağlamlığını və beyin fəaliyyətini dəstəkləməyə kömək edir.</li>
                      </ul>
                      <p><strong>Əks göstərişlər:</strong> BFMQƏ-nin hər hansı komponentinə qarşı fərdi həssaslıq.</p>
                      <p><strong>İstifadə qaydası və dozası:</strong> Böyüklər: 1 çay qaşığı gündə 2–3 dəfə yeməkdən 20 dəqiqə sonra daxilə qəbul edilir.</p>
                      <p><strong>Qəbul müddəti:</strong> Yağın minimum qəbul müddəti 1, maksimal isə 3 aydır. İl ərzində kurs 2–3 dəfə təkrarlana bilər.</p>
                      <p>Dərman vasitəsi deyildir. Bioloji fəallığa malik qida əlavəsidir.</p>
                      <p>Xəstəliklərin müalicəsi məqsədi ilə istifadə edilə bilməz.</p>
                      ...
                      <p>Hamiləlik və laktasiya dövründə, xəstəlik və dərman preparatlarının istifadəsi zamanı həkimlə məsləhətləşin.</p>
                      <p><strong>Buraxılış forması:</strong> 100 ml şüşə qabda, təlimat vərəqi ilə birgə karton qutuda yerləşdirilmişdir.</p>
                      <p><strong>Saxlama şəraiti:</strong> Qapalı ambalaj qutusunda 25°C-dən aşağı temperaturda, quru, günəş şüası düşməyən yerdə saxlanılmalıdır. Qapağı açıldıqdan sonra məhsulun qida dəyərini 1,5 ay saxlamaq tövsiyə olunur.</p>
                      <p>Təlimata uyğun şəkildə istifadə edin.</p>
                      <p><strong>Yararlılıq müddəti:</strong> 18 ay.</p>
                      <p><strong>İstifadə tarixi:</strong> Şüşə qabın üzərində qeyd olunub.</p>
                      <p><strong>İstehsalçı:</strong> “Ecovita” MMC, AZ 0125, Abşeron rayonu, Məmmədli kəndi.<br /><a href="http://www.ecovita.az">www.ecovita.az</a></p>
                    </motion.div>
                  )}
                </AnimatePresence>
              </div>
            ...
            <div className="product-info-section">
              ...
              <AnimatePresence>
                {expandedSection === "disinfectants" && (
                  ...
                  >
                    <p>
                      Məhsullarımız kənd təsərrüfatı, heyvandarlıq və ev təmizliyi kimi müxtəlif sahələrdə istifadə üçün uyğundur. Tərkibində zərərli kimyəvi maddələr yoxdur və dəriyə zərər vermədən təhlükəsiz istifadəni təmin edir.
                    </p>
                    <ul>
                      <li>Səth dezinfektanları mətbəx, vanna otağı və digər səthlərdə effektiv təmizlik təmin edir.</li>
                      <li>Sprey dezinfektanlar hava və səthlərdə portativ istifadə üçün idealdır.</li>
                      <li>Əl və gel sanitayzerlər dərini qoruyaraq uzunmüddətli təmizlik təklif edir.</li>
                      <li>Çoxməqsədli təmizləyicilər ekoloji təmiz formulası ilə hər cür səth üçün uyğundur.</li>
                      <li>Şüşə təmizləyicilər ləkəsiz parıltı və təmizlik təmin edir.</li>
                    </ul>
                    <p><strong>Əks göstərişlər:</strong> Məhsulların tərkibində olan hər hansı bir komponentə qarşı fərdi həssaslıq.</p>
                    <p><strong>İstifadə qaydası:</strong> Məhsulun qablaşdırmasındakı təlimatlara uyğun istifadə edin.</p>
                    <h4>Əlavə məlumat:</h4>
                    <p>Uşaqların əli çatmayan yerdə saxlayın.</p>
                    <p>Həmişə orijinal qablaşdırmada saxlayın!</p>
                    <p><strong>Yararlılıq müddəti:</strong> 24 ay</p>
                    <p><strong>İstehsalçı:</strong> “Ecovita” MMC, AZ1052, Abşeron rayonu Məmmədli kəndi.<br /><a href="http://www.ecovita.az">www.ecovita.az</a></p>
                  </motion.div>
                )}
              </AnimatePresence>
